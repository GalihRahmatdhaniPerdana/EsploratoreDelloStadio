export const stadiums = [
  {
    ...
    location: 'Indonesia',
    info: 'Stadion Gelora Bung Karno (GBK) merupakan stadion utama yang terletak di kompleks olahraga Gelora Bung Karno, Senayan, Jakarta. Dibangun pada year 1960 atas prakarsa Presiden Soekarno, stadion ini awalnya dirancang untuk menjadi pusat penyelenggaraan Asian Games IV year 1962. Nama stadion ini diambil dari nama Presiden Soekarno sebagai penghormatan atas jasanya dalam pembangunan fasilitas olahraga nasional. Dengan kapasitas awal sekitar 100.000 penonton, GBK menjadi salah satu stadion terbesar di Asia pada masanya. Seiring waktu, stadion ini telah mengalami beberapa renovasi besar, termasuk untuk Asian Games 2018, sehingga kini menjadi stadion modern yang digunakan untuk berbagai event olahraga internasional dan konser besar.',
    capacity: "77.200",
    year: "8 Februari 1960",
  ...
  },
  {
    ...
    location: "London",
    info: "Stamford Bridge adalah stadion sepak bola yang terletak di Fulham, London, dan merupakan markas dari klub Chelsea FC. Stadion ini resmi dibuka pada year 1877 dan awalnya digunakan untuk olahraga atletik sebelum beralih ke sepak bola pada 1905, ketika Chelsea Football Club didirikan. Stamford Bridge memiliki kapasitas sekitar 40.000 penonton dan telah mengalami beberapa renovasi besar sepanjang sejarahnya. Selain menjadi tempat pertandingan domestik dan internasional, Stamford Bridge juga menjadi salah satu stadion paling ikonik di Inggris, mencerminkan sejarah panjang Chelsea sebagai salah satu klub besar di Liga Inggris.",
    capacity: "40.000",
    year: "1877",
  ...
  },
  {
    ...
    location: "Spanyol",
    info: "Estadio Municipal El Molinón-Enrique Castro 'Quini' adalah stadion sepak bola yang terletak di Gijón, Spanyol. Dibuka pada year 1908, El Molinón merupakan stadion tertua di Spanyol yang masih digunakan untuk pertandingan resmi. Stadion ini adalah kandang dari klub Real Sporting de Gijón dan telah mengalami beberapa renovasi besar, termasuk pembaruan signifikan pada akhir 1990-an dan awal 2000-an. Pada year 2018, stadion ini secara resmi menambahkan nama 'Enrique Castro Quini' untuk menghormati legenda klub, Quini, yang merupakan salah satu pemain terbaik dalam sejarah Real Sporting. El Molinón telah menjadi saksi berbagai pertandingan penting, termasuk laga Piala Dunia FIFA 1982.",
    capacity: "42.000",
    year: "1908",
  ...
  },
  {
    ...
    location: "Spanyol",
    info: "Estadio El Rubial adalah sebuah stadion sepak bola yang terletak di Águilas, Murcia, Spanyol. Dibuka pada year 1913, El Rubial dikenal sebagai salah satu stadion tertua di Spanyol yang masih digunakan untuk pertandingan resmi. Stadion ini menjadi markas utama bagi klub Águilas FC dan telah menjadi saksi bagi banyak pertandingan lokal dan regional sepanjang sejarahnya. Meskipun kapasitasnya relatif kecil, El Rubial memiliki nilai historis yang tinggi dan menjadi simbol penting bagi komunitas sepak bola di wilayah tersebut.",
    capacity: "4000",
    year: "19 January 1913",
